...
import type { CreateLibp2pOptions, FullNode, Libp2p, Libp2pComponents, LightNode, ProtocolCreateOptions, RelayNode, ShardingParams } from "@waku/interfaces";
import { RelayCreateOptions } from "@waku/relay";
export { Libp2pComponents };
/**
 * Create a Waku node configured to use autosharding or static sharding.
 */
export declare function createNode(options?: ProtocolCreateOptions & WakuOptions & Partial<RelayCreateOptions>): Promise<LightNode>;
/**
...
export declare function defaultLibp2p(shardInfo?: ShardingParams, wakuGossipSub?: PubsubService["pubsub"], options?: Partial<CreateLibp2pOptions>, userAgent?: string): Promise<Libp2p>;
