...
export function contentTopicToPubsubTopic(contentTopic, clusterId = 1, networkShards = 8) {
 ...
 */
export function contentTopicsByPubsubTopic(contentTopics, clusterId = 1, networkShards = 8) {
 ...
 */
export function determinePubsubTopic(contentTopic, pubsubTopicShardInfo = DefaultPubsubTopic) {
