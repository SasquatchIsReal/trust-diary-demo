import { PubsubTopic, ShardingParams, SingleShardInfo } from "@waku/interfaces";
export declare const singleShardInfoToPubsubTopic: (shardInfo: SingleShardInfo) => PubsubTopic;
export declare const shardInfoToPubsubTopics: (shardInfo: ShardingParams) => PubsubTopic[];
