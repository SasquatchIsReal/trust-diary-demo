...
export declare class ConnectionManager extends EventEmitter<IPeersByDiscoveryEvents & IConnectionStateEvents> implements IConnectionManager {
    private configuredPubsubTopics;
