...
export declare namespace PeerExchangeQuery {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList) => PeerExchangeQuery;
}
...
export declare namespace PeerExchangeResponse {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList) => PeerExchangeResponse;
}
...
export declare namespace PeerExchangeRPC {
    ...
    const decode: (buf: Uint8Array | Uint8ArrayList) => PeerExchangeRPC;
}
